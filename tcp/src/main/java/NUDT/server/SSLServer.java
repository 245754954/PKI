...
public class SSLServer {
    ...
    public void init() {
        try {
            ...
            //
            ks.load(new FileInputStream(getClass().getClassLoader().getResource("kserver.keystore").getFile()), SERVER_KEY_STORE_PASSWORD.toCharArray());
            tks.load(new FileInputStream(getClass().getClassLoader().getResource("tserver.keystore").getFile()), SERVER_TRUST_KEY_STORE_PASSWORD.toCharArray());
